...
@Entity
@Table(name = "_technician", uniqueConstraints = @UniqueConstraint(columnNames = "saleManagerTechnicianId"))
public class Technician {
    ...
    private String saleManagerTechnicianId;  // e.g., TECH-001
    ...
    public String getSaleManagerTechnicianId() {
        return saleManagerTechnicianId;
    }

    public void setSaleManagerTechnicianId(String saleManagerTechnicianId) {
        this.saleManagerTechnicianId = saleManagerTechnicianId;
    }
